...
echo '<tr><td colspan="2" style="text-align: center; padding: 4px; background: #fd9c4e">'.$__lng['smayllar'].'</td><td colspan="2" style="text-align: center; padding: 4px; background: #fdddc2"><a href="stickers.php">'.$__lng['stikerler'].'</a></td></tr>';
...
foreach ($smilesArray as $smileKey => $smileImg ) {
  ...
  echo '<td width="10%"><img src="img/smiles/'.$smileImg.'.png" alt="'.$smileKey.'" /><br/>'.$smileKey.'</td>';
  $i++;
}
echo '</tr></table>';
