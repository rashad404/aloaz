...
echo '<tr><td style="text-align: center; padding: 4px; background: #fdddc2"><a href="smiles.php">'.$__lng['smayllar'].'</a></td><td style="text-align: center; padding: 4px; background: #fd9c4e">'.$__lng['stikerler'].'</td></tr>';
echo '</table>';
