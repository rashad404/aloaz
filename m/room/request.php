...
$checkQuery = mysql_query("SELECT `status` FROM `aloaz_db`.`room_subs` WHERE `rid` = '".$_rid."' AND `uid` = '".$id."'");
if(mysql_num_rows($checkQuery) > 0){
	...
	mysql_query("INSERT INTO `aloaz_db`.`room_subs` SET `rid` = '".$_rid."', `uid` = '".$id."', `time` = '".time()."'");
