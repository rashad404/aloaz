...
echo '<a href="add_photo.php">'.$__lng['shekil elave et'].'</a> | ';
...
if(!isset($_POST['submit'])){
	...
	mysql_query("UPDATE `aloaz_db`.`user` SET `password` = '".$_new_pass."', `md5_pass` = '".md5($_new_pass)."',`changed_pass` = 1 WHERE `id` = '".$id."' AND `md5_pass` = '".md5($_old_pass)."' LIMIT 1;");
	...
	}else echo 'Error 5566a'.mysql_error().$id;
}
