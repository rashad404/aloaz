...
$country_q = mysql_query("SELECT `country_code`,`country_name` FROM `aloaz_db`.`ip_tables` WHERE ".$ip2long." BETWEEN `ip_num_start` AND `ip_num_end`");
...
echo $__lng['yenisen']." <a href=\"register.php?refsite=".$refsite."\">".$__lng['pulsuz qeyd ol']."</a><br/><br/>";
...
echo '<a href="register.php" class="authButton">'.$__lng['qeyd ol'].'</a> ';
echo '</form>';
...
?>
<center>
<script type="text/javascript">document.write('<scr'+'ipt type="text/javascript" src="//mobilink.az/pub/20794?t='+new Date().getTime()+'" charset="utf-8" ></scr'+'ipt>');</script>
<br/>
