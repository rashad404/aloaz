...
$query = mysql_query("SELECT `id`, `nickname`, `sex`, `full_name`, `age`, `profile_photo`, `last_post`, `msg_count`, `msg_count_day` FROM `aloaz_db`.`user` ORDER BY ".$order_by." DESC LIMIT ".$start.", ".$show_limit.";");// WHERE `post_run` = '0'
