            ...
            <div class="col-md-12 share-block">
                <div class="share-block-content">
                    ...
                    <span class="share-block-username"><?php echo $user->nickname; ?></span>
                            <span class="share-block-date"><?php echo date("d/m/Y H:i",$image["add_date"])?>
                ...
                <div class="share-block-icons">
                    ...
                    <a class="cursor"  id="like-image" onclick="likeImage(<?= $image["id"] ?>);">
                        <img id="share-img-<?php echo $image["id"]; ?>" src="<?php if(\common\models\UserImage::liked(Yii::$app->user->id,$image["id"])) echo '/images/icons/share/liked.png'; else echo '/images/icons/share/like.png'; ?>">
                    ...
                    <?php
                    if($imag["user_id"]==$user_id){
                        echo '<a class="pull-right" href="'.\yii\helpers\Url::to(['/profile/delete-share/'.$image["id"]]).'" style="color: #428BCA;">Sil</a>';
                    }
                    ?>
