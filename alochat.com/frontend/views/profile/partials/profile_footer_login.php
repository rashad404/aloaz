...
<footer class="footer footer-chat">
    ...
    <div class="line1">
        <div class="container">
        <div class="row">
            <div class="col-xs-12 hidden-sm hidden-md hidden-lg footer-block text-center" style="padding-bottom:15px; padding-top: 0px;padding-right: 0px !important;padding-left: 0px !important; ">
                <span class="footer-lang"><a href="<?= Url::to(["/site/about"])?>"><?php echo Yii::t('app','About')?></a></span>
                <span class="footer-lang"><a href="<?= Url::to(["/site/privacy-policy"])?>"><?= Yii::t('app','Privacy & Policy terms')?></a></span>
                <span class="footer-lang"><a href="<?= Url::to(["/site/contact"])?>"><?= Yii::t('app','Contact')?></a></span>
            </div>
