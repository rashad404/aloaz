        ...
        <div class="col-md-12">
            ...
            <div class="pull-right" style="margin-top: -4px;">
                ...
                <select class="form-control" onchange="location = this.options[this.selectedIndex].value;" style="height: auto !important;padding: 3px;width: 148px;">
                    <option value="<?= Url::to(["/site/notifications/?p=0"])?>" <?php if($friend_filter==0) echo 'selected';else echo ''; ?>><?= Yii::t('app','Bütün bildirişlər')?></option>
                    <option value="<?= Url::to(["/site/notifications/?p=1"])?>" <?php if($friend_filter==1) echo 'selected';else echo ''; ?>><?= Yii::t('app','Baxılmayanlar')?></option>
                </select>
            </div>
        </div>
    </div>
