...
$this->beginContent('@frontend/views/layouts/maincopy.php'); ?>
...
<?php endif ?>
    ...
    <div class="right-bar hidden-md hidden-sm hidden-xs">
        ...
        <aside id="right-bar" style="text-align: center">
            ...
            <a href="http://bescore.com" target="_blank"><img class="img-responsive inline-block" align="center" src="<?= \yii\helpers\Url::base() ?>/images/livescore_ads.png" style="width:100%;"></a>
