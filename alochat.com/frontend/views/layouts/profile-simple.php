        ...
        <?php //////////////////////////////////////////////////////////////////////////////////////////////////////////?>
            ...
            <div class="row" style="margin: 0px !important;">
                <div class="col-md-9 col-lg-9 col-xs-12 col-sm-9">
                    <div class="row">
                        <?= \frontend\components\SimpleProfileLeftBarWidget::widget(['actionName' => Yii::$app->controller->action->id]);?>
                ...
                <div class="col-md-3 col-lg-3 hidden-xs hidden-sm profile-right">
                    ...
                    <div class="right-block">
                        <img class="inline-block ads-img" src="/images/livescore_ads.png" style="width:100%;" align="middle">
                    </div>
                </div>
            </div>
        <?php /////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
