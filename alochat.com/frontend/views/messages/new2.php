...
<div class="row">
    <div class="col-md-3 col-sm-6 col-lg-3 hidden-xs left-conversations">
...
<div class="msg-bg">
    <div class="menu">
        ...
        <div class="name"><?/*= \yii\helpers\Html::encode($currentConversation['full_name'])*/?></div>
        <div class="last"><?php
/*            $today = date("d");
...
/*    if($imageSendStatus) {
    ...
    */?>
     ...
     <div class="container-fluid" style="height: 45px;width: 100%;bottom:0px;left: 0px; right: 0px; position: fixed;z-index: 20">
        <div class="container">
            <div class="row" style="margin-left: 0px;">
                <div class="col-md-9 col-md-offset-3" style="background-color: #fff;height: 45px;">
    ...
    ?>
            <?=$form->field($messageSendForm, 'cid')->hiddenInput()->label(false) ?>
        <textarea placeholder="Mesaj yazin..." style="width: 90%;
height: 45px;
z-index: 99;
...
margin-top: -15px;"></textarea>
                    <button id="message-send-button" style="
    display: block; float: right;
    height: 34px;
    z-index: 101;color :#00B9E5 ;
    cursor: pointer;border: 0px; background-color: transparent;margin-top: -5px"
                    type="submit" onclick="sendMessage2();" <?/*= $submit_button_status; */?>><i class='fa fa-chevron-right  fa-2x'></i></button>
             <?/*= $form->field($messageSendForm, 'message')->textarea([
        'id' => "message-text",
        'class' => "textarea col-md-9 message-field chat-input",
        'placeholder' => Yii::t('app', 'Write a message') . "...",
        'readonly' => $input_readonly_status
