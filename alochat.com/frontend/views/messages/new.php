...
<script>
    ...
    <div class="menu">
        <div class="back"><a href="<?= Url::to(["/messages/index"])?>" style="color: #FFF"><i class="fa fa-chevron-left"></i> </a><img src="<?= Url::base() . $currentConversation['profile_photo'] ?>" draggable="false"/></div>
        ...
        <div  id="activity">
            ...
            foreach ($currentConversation['messages'] as $message):
                ...
                if(date("d-m",$message["o_time"]) == date("d-m")){
                    ...
                    $p_class = 'style="padding: 0px 0px 6px;"';
                }else {
